...
def teleop_defaults(config: dict[str, Any]) -> dict[str, Any]:
    ...
    mapping = {
        ...
        "external2_camera_serial": cameras.get("external2_serial"),
        "external2_camera_width": cameras.get("external2_width"),
        "external2_camera_height": cameras.get("external2_height"),
        "external2_camera_fps": cameras.get("external2_fps"),
...
def pi05_defaults(config: dict[str, Any]) -> dict[str, Any]:
    ...
    mapping = {
        ...
        "use_external2": pi05.get("use_external2"),
        "zmq_mode": pi05.get("zmq_mode"),
        "zmq_bind_host": pi05.get("zmq_bind_host"),
        ...
        "gripper_threshold": pi05.get("gripper_threshold"),
